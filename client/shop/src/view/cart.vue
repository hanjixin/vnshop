              ...
              <li v-for="item in cartList">
                ...
                <div class="cart-tab-5">
                  <div class="cart-item-opration">
                    <a href="javascript:;" class="item-edit-btn" style="color: #6d6d6d" @click="delCart(item.productId)">
          ...
          <div class="cart-foot-inner">
            <div class="cart-foot-l">
              <div class="item-all-check">
                <a href="javascipt:void(0);"   @click="checkAll()">
                                <span class="checkbox-btn item-check-btn" v-bind:class="{'check':allFalg}" >
            ...
            <div class="cart-foot-r">
              <div class="item-total">
                Item total: <span class="total-price">{{total}}</span>
              </div>
              <div class="btn-wrap">
...
<script>
  ...
  export default{
    ...
    methods:{
      getList:function () {
         axios.get('goods/lookCart?').then(res=>{
      ...
      editAll:function () {
        var checkAllFlag=null;
        if (this.allFalg=="0"){
          checkAllFlag="0";
        }else {
          checkAllFlag="1";
        }
        this.$http.post('/users/editCheckAll',{checkAll:checkAllFlag}).then(res=>{
          console.log(res.data)
        })
      },
      delCart:function (productId) {
        this.$http.post('/users/delCart',{productId:productId}).then(res=>{
          console.log(res.data.result);
          this.getList();
        })
      },
